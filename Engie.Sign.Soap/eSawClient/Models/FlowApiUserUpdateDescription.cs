...
namespace eSaw.Models
{
    ...
    /// <summary>
    /// This object is used for updating an existing user.
    /// Properties, which are not set will not change the existing value.
    /// </summary>
    public partial class FlowApiUserUpdateDescription
    {
        /// <summary>
        /// Initializes a new instance of the FlowApiUserUpdateDescription
        /// class.
        /// </summary>
        public FlowApiUserUpdateDescription() { }

        /// <summary>
        /// Initializes a new instance of the FlowApiUserUpdateDescription
        /// class.
        /// </summary>
        public FlowApiUserUpdateDescription(string email = default(string), string firstName = default(string), string lastName = default(string), string userName = default(string), string sid = default(string), string jobTitle = default(string), string phoneNumber = default(string), string role = default(string), bool? isUserManager = default(bool?), bool? isEnabled = default(bool?), string defaultSubject = default(string), string defaultMessage = default(string), bool? notifyRecipientOnActionNeeded = default(bool?), bool? notifySenderCompleteEnvelope = default(bool?), bool? notifySenderDeclined = default(bool?), bool? notifySenderDeliveryFailed = default(bool?), bool? notifySenderViewed = default(bool?), byte[] signatureImage = default(byte[]), IList<FlowApiUserAuthentication> authentications = default(IList<FlowApiUserAuthentication>))
        {
            Email = email;
            FirstName = firstName;
            LastName = lastName;
